...
Output main( float3 a_normal : NORMAL , float3 a_position : POSITION , float4 a_tangent : TANGENT , float2 a_texcoord0 : TEXCOORD0) { Output _varying_; _varying_.v_normal = float3(0.0, 0.0, 0.0);; _varying_.v_tangent = float4(0.0,0.0,0.0,1.0);; _varying_.v_texcoord = float2(0.0, 0.0);; _varying_.v_worldpos = float3(0.0, 0.0, 0.0);;
{
