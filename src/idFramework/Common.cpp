...
#include "idFramework/async/NetworkSystem.h"
#include "idFramework/BuildVersion.h"
#include "idFramework/Licensee.h"
#include "idFramework/Console.h"
#include "idFramework/Session.h"
#include "idFramework/Game.h"
...
==================
*/
static void Com_SdfEditor_f(const idCmdArgs & args) {
	sdfEditInt();
}
#endif
...
#endif
#ifdef BUILD_SDFEDITOR
	cmdSystem->AddCommand("sdfEditor", Com_SdfEditor_f, CMD_FL_TOOL, "launches the sdf editor");
#endif
#ifdef ID_ALLOW_TOOLS
	// editors
