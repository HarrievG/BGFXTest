...
{
public:
	TextBufferManager(idFont * _font);
	~TextBufferManager();
	...
	void appendText(TextBufferHandle _handle, const char* _string, const char* _end = NULL);

	/// Append a wide char unicode string to the buffer using current pen position and color.
	void appendText(TextBufferHandle _handle, const wchar_t* _string, const wchar_t* _end = NULL);
