...
private:
	...
	struct swfSPLineLoop_t {
		bool hole;
		idList< uint16 > vindex1;
		idList< uint16 > vindex2;
	};
	struct swfSPDrawFill_t {
		swfFillStyle_t style;
		idList< swfSPMorphEdge_t > edges;
		idList< swfSPLineLoop_t > loops;
	};
	...
	idList< idVec2 > verts;
	idList< swfSPDrawFill_t > fillDraws;
	idList< swfSPDrawLine_t > lineDraws;
