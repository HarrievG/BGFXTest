...
public:
	...
	idList< idVec2 > startVerts;
	idList< idVec2 > endVerts;
...
public:
	...
	swfRect_t endBounds;
	idList< idSWFShapeDrawFill > fillDraws;
	idList< idSWFShapeDrawLine > lineDraws;
};
...
public:
	swfRect_t bounds;
	swfMatrix_t matrix;
	idList< idSWFTextRecord > textRecords;
	idList< swfGlyphEntry_t > glyphs;
};
